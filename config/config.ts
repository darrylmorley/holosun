export const config = {
  ...
  // acceptURL: "https://www.holosun-optics.co.uk/result?accept=true",
  acceptURL: "http://localhost:3000/result?accept=true",
  // declineURL: "https://www.holosun-optics.co.uk/result?accept=false",
  declineURL: "http://localhost:3000/result?accept=false",
  // backURL: "https://www.holosun-optics.co.uk/cart",
  backURL: "http://localhost:3000/cart",
  // cancelURL: "https://www.holosun-optics.co.uk/result?accept=cancelled",
  cancelURL: "http://localhost:3000/result?accept=cancelled",
  // exceptionURL: "https://www.holosun-optics.co.uk/result?accept=exception",
