export default function Features() {
  return (
    <ul className="w-full grid grid-cols-2 gap-y-12 md:flex md:justify-around">
      <li className="flex flex-col items-center">
        ...
        <h3 className="text-sm text-center mt-4 font-semibold">Multilayer Coatings</h3>
      </li>
      <li className="flex flex-col items-center">
        ...
        <h3 className="text-sm text-center mt-4 font-semibold">Multi Reticle System</h3>
      </li>
      <li className="flex flex-col items-center">
        ...
        <h3 className="text-sm text-center mt-4 font-semibold">Shake Awake</h3>
      </li>
      <li className="flex flex-col items-center">
        ...
        <h3 className="text-sm text-center mt-4 font-semibold">Solar Failsafe</h3>
      </li>
      <li className="flex flex-col items-center">
        ...
        <h3 className="text-sm text-center mt-4 font-semibold">Super LED</h3>
      </li>
      <li className="flex flex-col items-center">
        ...
        <h3 className="text-sm text-center mt-4 font-semibold">Titanium</h3>
      </li>
    </ul>
  )
}