        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <nav className="flex flex-col space-y-2">
              <Link href="/shop/category/red-dot-sights" className="link link-hover">
                Red Dot Sights
              </Link>
              <Link href="/shop/category/reflex-sights" className="link link-hover">
                Reflex Sights
              </Link>
              <Link href="/shop/category/lasers" className="link link-hover">
                Lasers
              </Link>
              <Link href="/shop/category/magnifiers" className="link link-hover">
                Magnifiers
              </Link>
              <Link href="/shop/category/mounts-and-rails" className="link link-hover">
                Mounts
              </Link>
            </nav>
          </div>
          ...
          <div>
            ...
            <nav className="flex flex-col space-y-2">
              <Link href="/support/faq" className="link link-hover">
                FAQ
              </Link>
              <Link href="/support/model-guide" className="link link-hover">
                Model Guide
              </Link>
              ...
              <Link href="/support/contact-us" className="link link-hover">
                Contact Us
              </Link>
              <a
